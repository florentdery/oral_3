...
- Certaines variables semblent avoir des mesures erronnées, surtout pour l'oxygène, le pH et des valeurs extrèmes de temperature. 
...
- Les étangs plus cruex et plus grands semblent avoir une richesse spécifique supérieure. Nous considéreront la topographie des étangs comme des covariables. 
## Choix de l'analyse (étape 7)

Nous avons décidé d'utiliser une analyse de redondance partielle pour analyser comment la présence de clôture, l'utlisation des étangs par les vaches et les variables physico-chimiques en plus des facteurs abiotiques font varier la communauté d'amphibiens, en prennant en compte l'effet de l'aire et de la profondeur des étangs comme co-variables.

...
```{r distribution_xs,  echo=F, warnings=F, message=F, fig.align="center", fig.dim=c(10,4.3) }
...
```
- Des clôtures sont présentes sur 5 étangs tandis qu'elles sont absentes des 35 autres étangs.
- 3 étangs sont clôturés mais ne semblent pas avoir été utilisés par les vahces (pas de fèces)
...
```{r distribution_covariables,  echo=F, warnings=F, message=F, fig.align="center", fig.dim=c(10,4.3) }

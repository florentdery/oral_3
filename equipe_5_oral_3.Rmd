...
En ce qui concerne les poissons et les écrevisses, i8l semble y avoir beaucoup de zéros. Il faudra 
...
On a déjà jetté un coup d'oeil à la distribution des abondances relatives d'amphibien à l'étape 4. 
On peut toute fois regarder avec le compte d'espèces à chaque site (convertir les abondances relatives en 0-1 pour chaque site)

#HERE

```{r abberent_Ys, echo=F, warnings=F, message=F, fig.align="center", fig.dim=c(8,4) }

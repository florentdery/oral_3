...
On peut toutefois regarder avec le compte d'espèces à chaque site (convertir les abondances relatives en 0-1 pour chaque site)

```{r}
#some code for transformation of variables
```
